...
def parse_arguments():
    ...
    # training
    parser.add_argument('--epochs', type=int, default=556)
    ...
    parser.add_argument('--lr_decay', type=float, default=1/10)
    parser.add_argument('--decay_lr_every', type=int, default=185)
